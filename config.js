...
const CONFIG = {
    ...
    COUNSELORS: [
        "-- Select Counselor --",
        "Byrd, Krista M., PA-C, PA-C",
        "Carlson, MD Addiction Psychiatrist, Katherine",
        "Cisney, Natalie, PA-C",
        "Collins, Maureen, CMHC",
        "Hildt, LMFT, David M.",
        "Mechan, Layna, SUDC; Substance Use Disorder Counselor",
        "Merkley, Alec, CMC, MSW-I",
        "Micic, Ivana, LCSW",
        "SAndi, Kristina, CSW",
        "Whiting, Bret"
    ],
